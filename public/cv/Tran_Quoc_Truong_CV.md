...
# Selected Projects
## **Omni-Agent — AI Agent Hub**

Independent AI platform for versioned document knowledge workflows and agent evaluation, coordinated through a Django/DRF control plane.
...
Client delivery work at FPT Software covering omnichannel core banking and financial transaction integrations across API, database, regression, and automation testing.
...
# Technical Skills
**Applied AI & Evaluation:** RAG, Hybrid Retrieval, Agentic Workflows, LLM Evaluation, LLM-as-a-Judge, Evaluation Datasets, Judge/Critic/Meta-Judge Patterns, LoRA/QLoRA

**AI Tooling & Observability:** LangGraph, LangChain, LiteLLM, Langfuse, Qdrant, Docling, OCR and Document Processing

**Backend & API Engineering:** Python, Django/DRF, FastAPI, REST APIs, OpenAPI, Asynchronous Workers, Service Layers, Domain Modeling, Job Lifecycle Management

**Data, Storage & Infrastructure:** PostgreSQL, Redis, Celery, S3/MinIO, Docker, Docker Compose, Nginx, Cloudflare, Presigned URLs

**Quality Engineering & Domain:** API Validation, SQL Validation, Regression Testing, Test Automation, CI/CD, Git, Core Banking, Payment Hub, E-Commerce
